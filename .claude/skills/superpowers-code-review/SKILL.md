...
description: Use when completing tasks, implementing major features, or before merging — dispatch code-reviewer subagent to catch issues before they cascade
---
...
[Dispatch code-reviewer subagent]
  ...
  PLAN_OR_REQUIREMENTS: Task 2 from docs/superpowers/plans/feature.md
  BASE_SHA: a7981ec
  HEAD_SHA: 3df7661
